...
dotenv_path = BASE_DIR / "scratch.env"
...
SECRET_KEY = 'django-insecure-0*eb4i^9i75k6qm8mrwk07#yz42rvy8bra9@36vmwf7-57y%m('
...
STATIC_URL = 'static/'
# Set the STATIC_ROOT to the directory where you want to collect static files
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')
# Default primary key field type
# https://docs.djangoproject.com/en/5.2/ref/settings/#default-auto-field

DEFAULT_AUTO_FIELD = 'django.db.models.BigAutoField'
LOGIN_URL = '/login/'          # URL where users should log in
